            ...
            <ul class="navbar-nav mr-auto">
              ...
              -->
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink-333" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Vérification(s)
                    </a>
                    <div class="dropdown-menu " aria-labelledby="navbarDropdownMenuLink-333">
                        <a class="dropdown-item" href="e_verification.php">Enregistrer</a>
                        <a class="dropdown-item" href="l_verif_att.php">En cours</a>
                        <a class="dropdown-item" href="l_verif_ter.php">Terminé</a>
                    </div>
                </li>
                <li class="nav-item dropdown">
