...
FROM `ria_pia`
WHERE ria_pia.type='RIA' AND ria_pia.etat=1 AND ria_pia.id_site=? AND ria_pia.id NOT IN (SELECT ria_pia.id FROM `ria_pia` INNER JOIN verfi_ria ON ria_pia.id=verfi_ria.id_ria WHERE ria_pia.etat=1 AND ria_pia.id_site=? AND verfi_ria.id_verification=?)");
