...
//Requête extincteurs non vérifés
$req_extincteur_non_verif = $db->prepare("SELECT extincteur.id, CONCAT(DATE_FORMAT(extincteur.date_ajout, '%d'), '/', DATE_FORMAT(extincteur.date_ajout, '%m'),'/', DATE_FORMAT(extincteur.date_ajout, '%Y')), extincteur.emplacement, extincteur.type, extincteur.marque, extincteur.annee_fabrication, extincteur, CONCAT(DATE_FORMAT(extincteur.date_derniere_verif, '%d'), '/', DATE_FORMAT(extincteur.date_derniere_verif, '%m'),'/', DATE_FORMAT(extincteur.date_derniere_verif, '%Y'))
FROM `extincteur`
INNER JOIN verfi_extincteur ON verfi_extincteur.id_extincteur=extincteur.id
WHERE extincteur.etat=1 AND extincteur.id_site=? AND verfi_extincteur.id_verification=? ");
$req_extincteur_non_verif->execute(array($id_site, $id_verif));
...
<head>
    <title>Extincteurs du site : <?= $nom_site ?> </title>
    <?php include 'css.php'; ?>
</head>
            ...
            <div class="row text-center">
                ...
                <div class="card-body card-body-cascade col-md-12 mb-4">
                    ...
                    <div class="card card-cascade narrower col-12">
                        ...
                        <div class="view view-cascade gradient-card-header blue-gradient">
                            <h3 class="mb-0">Extincteurs pas encore vérifés du site : <b><?= $nom_site ?></b>
                            </h3>
                        </div>
                        <!-- /Card image -->
                ...
                <div class="card-body card-body-cascade col-md-12 mb-4">
                    ...
                    <div class="card card-cascade narrower col-12">
                        ...
                        <!-- Card image -->
                        <div class="view view-cascade gradient-card-header blue-gradient">
                            <h3 class="mb-0">Extincteurs vérifés du site : <b><?= $nom_site ?></b>
                            </h3>
                        </div>
                        <!-- /Card image -->
                            ...
                            <div class="row table-responsive ">
                                <table class="table  table-hover w-auto centered  card-body ml-3">
                                    ...
                                    <tbody>
                                        <?php
                                        $i = 1;
                                        while ($donnees = $req_extincteur_non_verif->fetch()) {
                                            $azote = "d-none";
                                            $co2 = "d-none";
                                            $sparklet = "d-none";
                                            $id_ext = $donnees['0'];
